 ...
 */
export const TONE_NAMES: readonly string[] = Object.freeze([
  '', // 0 (unused)
 ...
 */
export const SEAL_NAMES: readonly string[] = Object.freeze([
  '', // 0 (unused)
 ...
 */
export const SEAL_COLORS: Readonly<Record<number, string>> = Object.freeze({ 1: '紅', 2: '白', 3: '藍', 0: '黃' });
...
export class DreamspellEngine extends BaseEngine {
   ...
   * @param month  1–12
   * @param day    1–31
   * @returns Kin in 1–260
   */
  #kinOf(year: number, month: number, day: number): number {
   ...
   */
  #dreamspellDay(year: number, month: number, day: number): number {
   ...
   */
  #leapDaysUpTo(year: number, month: number, day: number): number {
  ...
  /**
   * @returns Whether the Gregorian year has a 29 Feb.
   */
