...
import { analyzeCompatibility, COMPATIBILITY_SCHEMA_VERSION, VERSION } from '../src/index.js';

const FIRST = { year: 1991, month: 10, day: 5, hour: 14, gender: 'female', name: 'A' };
const SECOND = { year: 1986, month: 5, day: 29, hour: 8, gender: 'male', name: 'B' };
