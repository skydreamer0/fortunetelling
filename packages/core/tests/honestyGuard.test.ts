...
import { HonestyGuard, QUALITATIVE_PATTERNS } from '../src/index';
...
function emptyShellReport() {
  return {
    stateTable: { scenarios: [] as any[], pending: true },
    evolution: { periods: [] as any[], narrative: '', pending: true },
    honesty: { languageRules: [] as any[], violations: [] as any[], pending: true },
  };
}
