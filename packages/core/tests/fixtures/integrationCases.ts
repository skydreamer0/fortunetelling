import type { BirthDataParams } from '../../src/core/models/BirthData';

export interface FixtureBirthplace {
  label: string;
  lat: number;
  lng: number;
  timezone: string;
...
export interface IntegrationCase {
  id: string;
  kind: string;
  input: BirthDataParams & { birthplace?: FixtureBirthplace };
  asOf: string;
  provenance: Record<string, any>;
  expected: Record<string, any>;
}

export const INTEGRATION_CASES: readonly IntegrationCase[] = Object.freeze<IntegrationCase[]>([
  {
