...
import { SummaryBuilder, SUMMARY_VERSION } from '../src/index';
import type { Component, SystemResultLike } from '../src/core/models/SystemResult';

function component(id: string, name: string, category: string, value: any): Component {
  return { id, name, category, value };
}

function engine(engineId: string, engineName: string, components: Component[]): SystemResultLike {
